...
| Arbiter | [arbiter.md](industry/arbiter.md) | Phase 3 — T2 opportunity scanner, BOM trees, multi-scope assets, tax profiles, blacklist/whitelist, manufacturing profiles |
...
| Design Tokens | [design-tokens.md](infrastructure/design-tokens.md) | 3-tier visual hierarchy, token system, CSS variables, Tailwind mapping |
